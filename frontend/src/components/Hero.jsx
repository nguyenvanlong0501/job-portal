    ...
    <section className="bg-gradient-to-r from-blue-50 to-indigo-100 rounded-lg py-16 px-6 md:px-20">
      <div className="text-center max-w-2xl mx-auto">
        ...
        <motion.h1
          ...
          animate="visible"
        >
          Có <span className="text-blue-700">rất nhiều cơ hội</span> việc làm đang chờ
          bạn!
        </motion.h1>
        ...
        <motion.p
          ...
          animate="visible"
        >
          Bước đột phá trong sự nghiệp bắt đầu từ đây - khám phá những cơ hội việc làm tốt nhất và thực hiện bước đầu tiên hướng tới tương lai của bạn!
        </motion.p>
